...
깃헙의 Edit 인터페이스를 통해 Markdown파일을 수정할 수 있습니다. 여기에서 이미지를 마크다운 파일안에 추가하고 싶다면 단순히 내 컴퓨터의 이미지 파일을 원하는 위치에 드래그앤드롭만 하면 됩니다.  
이미지의 크기를 일관성있게 조절하고 싶다면, html 태그속성도 이용할 수 있습니다.
